...
const typeClasses = computed(() => {
  switch (props.type) {
    ...
    case 'secondary':
      return 'rounded-md md:rounded-2xl w-[70px] md:w-[90px] h-[30px] md:h-[40px] font-semibold border-[none] bg-[rgb(188,182,182)] text-gray-900 hover:bg-[#8e8989]';
    case 'bar':
      return 'rounded-md h-[26px] md:h-[28px] font-semibold px-4 py-2';
    case 'danger':
      return 'rounded-md md:rounded-2xl w-[70px] md:w-[90px] h-[30px] md:h-[40px] font-semibold border-[none]  bg-red-600 text-white hover:bg-red-700';
    default:
